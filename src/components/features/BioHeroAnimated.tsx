...
export function BioHeroAnimated() {
  ...
  return (
    ...
    >
      <div className="w-full border-2 border-primary-500/80 rounded-3xl p-6 md:p-16 lg:p-20 bg-surface/30 hover:shadow-glow-primary transition-[border-color,shadow] hover:border-primary-500 duration-500">
        <div className="w-full flex flex-col items-center">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 mb-8">
            ...
            >
              ...
              <div className="relative w-32 h-32 md:w-44 md:h-44 rounded-full border-2 border-primary-500/80 overflow-hidden bg-surface flex items-center justify-center group-hover:shadow-glow-primary transition-all duration-500 group-hover:border-primary-500">
                <Image
          ...
          <motion.div variants={sectionVariants} className="space-y-6 flex flex-col items-center w-full">
            <div className="space-y-4">
              <h2 className="text-lg md:text-2xl font-mono text-primary-400/60 uppercase tracking-[0.2em] font-black text-center">
                {t('hero.role')}
              </h2>
              <div className="flex items-center justify-center space-x-3 opacity-60">
                <span className="h-px w-6 bg-primary-500/50" />
                <span className="text-primary-500 font-mono text-xs tracking-widest uppercase">
                  {t('hero.location')}
                </span>
                <span className="h-px w-6 bg-primary-500/50" />
              </div>
